...
Also prettify that markdown file.
...
- must include proper markdown table if original image contain table
...
- process each images 1 by 1, not all at once
- for how many images until you stop, if I don't tell you, that means, only stop when you finished all the images